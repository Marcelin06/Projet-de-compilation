...
int yyerror(double *arg, const char* msg); // on fonctions defined by the generator
%}
...
%%
int yyerror(double *arg, const char *msg){ // called by the parser if the parsing fails
    printf("Parsing:: syntax error %f\n", *arg);
